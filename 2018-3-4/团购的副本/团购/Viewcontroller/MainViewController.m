...
- (void)viewDidLoad {
    ...
    vc_home.tabBarItem.image=[UIImage imageNamed:@"主页.png"];
    ...
    vc_business.tabBarItem.image=[UIImage imageNamed:@"购物.png"];
    ...
    vc_user.tabBarItem.image=[UIImage imageNamed:@"用户.png"];
