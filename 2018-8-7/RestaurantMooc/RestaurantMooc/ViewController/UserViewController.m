...
- (void)viewDidLoad {
    ...
    view_head .backgroundColor=MYCOLORBLUE;
    [self.view addSubview:view_head];
    
    MyButton *bt_userName=[[MyButton alloc] initWithFrame:CGRectMake(10, 40, 60, 60) imageFrame:CGRectMake(0, 0, 60, 60) titleFrame:CGRectZero];
    [bt_userName setImage:[UIImage imageNamed:@"userImage.png"] forState:UIControlStateNormal];
    [view_head addSubview:bt_userName];
    
    UILabel *lab=[[UILabel alloc] initWithFrame:CGRectMake(90, 60, 100, 20)];
    lab.text=@"我的账户";
